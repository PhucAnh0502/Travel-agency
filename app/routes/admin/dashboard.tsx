        ...
        <main className='wrapper dashboard'>
            ...
            <section className="flex flex-col gap-6">
                <div className='grid grid-cols-1 md:grid-cols-3 w-full gap-6'>
                    ...
                    <StatsCard
                        ...
                        currentMonthCount={dashboardStats.userRole.lastMonth}
            ...
            <section className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                <ChartComponent
                    ...
                    tooltip={{enable: true}}
                >
                    <Inject services={[ColumnSeries, SplineSeries, Category, DataLabel, Tooltip]}/>
                    <SeriesCollectionDirective>
                        <SeriesDirective dataSource={userGrowth} xName="day" yName="count" type="Column" name="Column"
                                         columnWidth={0.3} cornerRadius={{topLeft: 10, topRight: 10}}/>
                    </SeriesCollectionDirective>
                </ChartComponent>
                ...
                >
                    <Inject services={[ColumnSeries, SplineSeries, Category, DataLabel, Tooltip]}/>
                    <SeriesCollectionDirective>
                        <SeriesDirective dataSource={tripsByTravelStyle} xName="travelStyle" yName="count" type="Column" name="day"
                                         columnWidth={0.3} cornerRadius={{topLeft: 10, topRight: 10}}/>
                    </SeriesCollectionDirective>
                </ChartComponent>
            </section>
